...
export default function Header() {
  ...
  return (
    <header className="w-full font-montserrat relative z-0">
      {/* VIDEO HERO SECTION */}
      ...
      <div className="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-b from-transparent to-black/30 pointer-events-none z-0" />
